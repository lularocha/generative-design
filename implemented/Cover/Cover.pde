...
String[] fontNames = {
  "FreeSansBold.ttf", "FreeSansBold.ttf", "FreeSansBold.ttf", "FreeSansBold.ttf", "FreeSansBold.ttf", "FreeSansBold.ttf"
};
int[] fontSizes = {
  72, 25, 25, 14, 20, 14
};
float[] lineSpacings = {
  0.9, 1.1, 1.1, 1.2, 1.2, 1
};
float[] typoSegmentLengths = {
  3.5, 3.5, 3.5, 3.5, 3.5, 3.5
};
float[] textPosXs = {
  205, 448.5, 449.5, 261, 505, 505
};
float[] textPosYs = {
  188, 313, 370, 424, 730, 752
};
float[] textScaleXs = {
  1, 1, 1, 1, 1, 1
};
